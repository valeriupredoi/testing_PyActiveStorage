...
def gold_test():
    ...
    # bigger_file = "cl_Amon_UKESM1-0-LL_ssp370SST-lowNTCF_r1i1p1f2_gn_205001-209912.nc"  # 2.3GB about 4800 chunks
    # bigger_file = "da193a_25_day__198808-198808.nc"  # 3GB 30 HDF5 chunks
    bigger_file = "da193a_25_6hr_t_pt_cordex__198807-198807.nc"  # m01s30i111
    ...
    # 'UM_m01s16i202_vn1106' 'UM_m01s30i202_vn1106' 'cl'
    # active = Active(test_file_uri, 'UM_m01s16i202_vn1106', interface_type="s3",
    ...
    active = Active(test_file_uri, 'm01s30i111', interface_type="s3",  # 'm01s06i247_4', interface_type="s3",
                    storage_options=storage_options,
                    active_storage_url=active_storage_url)
    # active = Active(test_file_uri, 'cl', interface_type="s3",
    #                 storage_options=storage_options,
    #                 active_storage_url=active_storage_url)
